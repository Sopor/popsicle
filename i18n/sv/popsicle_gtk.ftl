...
image-view-description = Välj .iso- eller .img-fil som du vill bränna till din USB-enhet. Du kan också välja att mata in din enhet redan nu,
...
devices-view-description = Genom att bränna denna enhet kommer all data att tas bort.
...
win-isos-not-supported = Windows ISO-filer stöds för närvarande inte
